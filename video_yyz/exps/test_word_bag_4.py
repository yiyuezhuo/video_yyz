'''
test_word_bag_3 without random crop (not work well)
'''
import sys
...
args_list = [
    '--train', 'train_video_dataset_1_rgb_fast', 'transform_train_2', 'val2vl', 'video_random_3',
    '--test', 'test_video_dataset_1_rgb_fast', 'transform_test_2', 'val2vl', 'video_uniform_3',
